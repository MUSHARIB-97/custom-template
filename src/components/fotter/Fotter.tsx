    ...
    <div>
      <div className="row parent-container">
        ...
        >
          ...
          <div className="fotter-logo-container-text mt-4">
            <p>
            ...
            <div>
              <ul className="">
                <li className="d-flex text-center gap-1">
      ...
      <div className="rights py-1">
        <p>Copyright © Omni World Commerce. All Right reserved!</p>
      </div>
    </div>
  );
};
